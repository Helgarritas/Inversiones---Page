    ...
    <>
      <article className={`inforProject ${boolean?'':'inforProject__event1'}`}>
        <section className={`inforProject__container ${boolean?'':'inforProject__event2'}`}>
          <div className='inforProject__delete' onClick={()=>chancheBoolean(false)}>
          ...
          <h2 className='inforProject__title'>{DataProjectFilterCard.title}</h2>
          <div className='inforProject__content'>
            <p>{DataProjectFilterCard.description}</p>  
            <img src={DataProjectFilterCard.image} alt="" />  
          </div>
          <div className='inforProject__content2'>
            <img src={image} alt="" />  
            <div className='inforProject__cards'>
              {DataProjectIcon.map((obj,index)=>(
                <div className='inforProject__card' key={index}>
                    <div className='inforProject__card--title'>
                      {obj.icon}
                      <p>{obj.title}</p>
                    </div>
                    <p className='inforProject__card--description'>
                      {DataProjectFilterCard.specifications[index]}
                    </p>
                </div>                
              ))}
            </div>       
