  ...
  return (
    <section className='homeProjects'>
      ...
      <div className='homeProjects__description'>
        ...
        <p>Descubre cómo convertimos ideas en soluciones efectivas a través de nuestros proyectos recientes, reflejando nuestra pasión por la calidad y la tecnología</p>
        <ButtonSecondary description={'Descubrir'} fill={'white'}></ButtonSecondary>
      </div>
